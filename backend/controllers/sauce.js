...
}; //Utilisation de l'Id reçu en paramètre pour accéder à la sauce correspondante dans la base de données. L'url d'image contient un segment /images/ pour séparer le nom du fichier. Utilisation de la fonction unlink pour supprimer le fichier. Dans le callback, supression de la sauce dans la base de donnée
